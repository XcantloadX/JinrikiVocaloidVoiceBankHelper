...
namespace JinrikiVocaloidVBHelper.Automation
{
    ...
    public class AuditionExtendScriptController : AuditionController
    {
        ...
        public override void SaveSelection(string fileName, string filePath)
        {
            ...
            System.Diagnostics.Process p = System.Diagnostics.Process.Start("tools\\ffmpeg.exe", string.Format("-y -i {0} -ac 48000 -acodec pcm_s16le {1}", tempPath, System.IO.Path.Combine(filePath.EscapeSplash(), fileName)));
            p.WaitForExit();
